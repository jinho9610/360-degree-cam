...
if __name__ == '__main__':
    print("Training KNN classifier...")  # dataset train 시작
    ...
    output_movie = cv2.VideoWriter('output.avi', fourcc, 29.97, (w, h))
    ...
    while input_video.isOpened():
        ...
        output_movie.write(show_prediction_labels_on_image(img, predictions))
